...
class DatabaseHandler:
  ...
  def create_default_table(self):
    ...
    NAVIGATION = "CREATE TABLE IF NOT EXISTS NAVIGATION (TIMESTAMP INT NOT NULL, CASE_ID INT NOT NULL, HOST_ID INT NOT NULL, MD_ID INT NOT NULL, REPORT_ID INT NOT NULL, LATITUDE INT NOT NULL, LONGITUDE INT NULL, NOTE STRING NOT NULL);"
